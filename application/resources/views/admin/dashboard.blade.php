...
<div class="row gy-4">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">@lang('Podcast Subscription') (@lang('Last 10 days'))</h5>
...
<script>
    ...
    colors: ['#BADA55'],
        labels: @json($subscription['labels']),
    xaxis: {
        type: 'date',
            },
    yaxis: {
    ...
    // Episode Listening Report Start
